...
const radioProps = [
  { name: 'Align Items', littleName: 'alignItems', values: ['flex-start', 'center'] },
...
const boolProps = [
  {name: 'Dense', littleName: 'dense'},
  {name: 'Button', littleName: 'button'},
  {name: 'Divider', littleName: 'divider'},
  {name: 'Disable Padding', littleName: 'disablePadding' },
  {name: 'Disable Gutters', littleName: 'disableGutters' },
];
...
export default withRouter(withStyles(styles)(ListEditor));
